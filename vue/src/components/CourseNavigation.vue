      ...
      <div v-for="week in weeks" :key="week.number" class="border rounded-lg">
        ...
        <div v-if="expandedWeek === week.number" class="p-4 border-t space-y-4">
          ...
          <div class="space-y-2">
            ...
            <div v-for="topic in week.topics" :key="topic.id" class="pl-4 py-2 hover:bg-gray-50 cursor-pointer"
          ...
          <div>
            ...
            <div class="pl-4 py-2 hover:bg-gray-50 cursor-pointer" @click="goToga(week.gradedAssignment.id)">
          ...
          <div>
            ...
            <div v-for="assignment in week.programmingAssignments" :key="assignment.id"
              class="pl-4 py-2 hover:bg-gray-50 cursor-pointer" @click="goTopa(assignment.id)">
              {{ assignment.title }}
            </div>
          </div>
        </div>
...
const weeks = ref(Array.from({ length: 4 }, (_, i) => ({
  number: i + 1,
